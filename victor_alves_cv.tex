...
\section{Education}
  ...
  \resumeSubHeadingListStart
    ...
    \resumeEducationHeading
      ...
      {Ph.D. Student, Chemical Engineering;}{Aug 2022 \textbf{--} May 2027 (Expected, flexible)}
      {}{}
        % \resumeItemListStart
    ...
    \resumeEducationHeading
      ...
      {B.Sc., Chemical Engineering;}{Apr 2017 \textbf{--} Apr 2022}
      {}{}
    ...
    \resumeSubheading
      ...
      {Graduate Research Assistant (Ph.D.)}{Aug 2022 \textbf{--} Currently}
        \resumeItemListStart
            ...
            \resumeItem{Collaboration with Columbia University: Modeling and simulation of ex-situ 
            carbon mineralization using coal fly ash.}
            \resumeItem{Collaboration with University of Maryland: 
            Techno-economic analysis for depolymerization of plastics using electrified spatiotemporal heating}
        \resumeItemListEnd
    ...
    \resumeSubheading
      ...
      {Undergraduate Research  (B.Sc.)}{Sept 2020 \textbf{--} Sept 2021}
        \resumeItemListStart
            ...
            CSharp to evaluate the intensification of ethylbenzene production 
   ...
   \resumeSubheading
    ...
    \resumeSubheading
      ...
      {MES MOM and Automation Associate (Full-Time)}{Dec 2021 \textbf{--} Jun 2022}
        \resumeItemListStart
            \resumeItem{Application of the PI System™ and Aspen InfoPlus.21® software to collect, store, view, analyze, and share operational data with users.}
...
{\item}
\nocite{*}
\printbibliography[env = bibliography, title= Selected Research Contributions- Complete list on my {\href{https://scholar.google.com/citations?user=https://scholar.google.com/cit&hl=&user=ANQED-oAAAAJ}{\color{blue}Google Scholar.}} ]
