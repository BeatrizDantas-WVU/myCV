...
\begin{center}
    \textbf{\Huge \scshape Beatriz Dantas} \\ \vspace{3pt}
    \small
    \faMobile \hspace{.5pt} \href{tel:13042449132}{\color{blue}+1-304-244-9132}
    $|$
    \faAt \hspace{.5pt} \href{mailto:bnd00011@mix.wvu.edu}{\color{blue}bnd00011@mix.wvu.edu}
    $|$
    \faLinkedinSquare \hspace{.5pt} \href{https://www.linkedin.com/in/beatriznadantas/}{\color{blue}LinkedIn}
    $|$
    \faGithub \hspace{.5pt} \href{https://github.com/BeatrizDantas-WVU}{\color{blue}GitHub}
    %$|$
...
\section{Education}
  ...
  \resumeSubHeadingListStart 
    ...
    \resumeSubheading
      ...
      {Ph.D. Student, Chemical Engineering \textbf{--} GPA: 4.0/4.0}{Aug 2022 \textbf{--} May 2027 (Expected)}
      {}{}
        % \resumeItemListStart
      ...
      {B.Sc., Chemical Engineering \textbf{--} GPA: 3.49/4.0}{Apr 2017 \textbf{--} Apr 2022}
      {}{}
...
\section{Research Experience}
  ...
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      {Graduate Research Assistant (Ph.D.)}{Aug 2022 \textbf{--} Currently}
        \resumeItemListStart
            \resumeItem{Proton Exchange Membrane Water Electrolysis (PEMWE) system assessment via flexibility and operability analysis}
            \resumeItem{Modeling and simulation of ex-situ 
            carbon mineralization and rare earth elements extraction using coal fly ash}
        \resumeItemListEnd
    
    \resumeSubheading
      {Federal University of Campina Grande}{Campina Grande, Paraiba, Brazil}
      {Undergraduate Research  (B.Sc.)}{Sept 2020 \textbf{--} Sept 2021}
        \resumeItemListStart
            \resumeItem{B.Sc. final project: ``Integrated platform developed in 
            C\# to evaluate the intensification of ethylbenzene production 
            using the GREENSCOPE methodology}
        \resumeItemListEnd
    

    \resumeSubheading
    {Federal University of Campina Grande}{Campina Grande, Paraiba, Brazil}
    {Undergraduate Research  (B.Sc.)}{Sep 2019 \textbf{--} Apr 2022}
      \resumeItemListStart
...
\section{Work Experience}
  ...
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      {Automation Analyst (Full-Time)}{Dec 2021 \textbf{--} Jun 2022}
        \resumeItemListStart
    ...
    {Summer Intern}{May 2021 \textbf{--} Aug. 2021}
      \resumeItemListStart
    ...
    \resumeSubheading
    {Accenture}{Campina Grande, Paraiba, Brazil}
    {Automation Analyst (Part-Time)}{Nov 2020 \textbf{--} Nov 2021}
      \resumeItemListStart
          \resumeItem{Application of the AVEVA PI System and Aspen InfoPlus.21 software to collect, store, view, analyze, and share operational data with users}
          \resumeItem{Understand and refine processes, working with clients to simplify, standardize and automate work and business processes found in manufacturing}
        \resumeItemListEnd
...
% ---------- CONFERENCE AND ARTICLE PUBLICATIONS -------
...
{\item}
\nocite{*}
\printbibliography[env = bibliography, title= Research publications and presentations - Complete list on my {\href{https://scholar.google.com/citations?user=https://scholar.google.com/cit&hl=&user=ANQED-oAAAAJ}{\color{blue}Google Scholar.}} ]
...
\section{Skills}
  ...
  \resumeSubHeadingListStart
    \small{\item{
        \textbf{Programming:}{ Python, MATLAB, C\#, Visual Basic for Applications (VBA), R} \\ \vspace{3pt}
...
\section{Relevant Coursework}
  ...
  \resumeSubHeadingListStart
    \small{\item{
        \textbf{Required coursework:}{ Transport Phenomena, Advanced Chemical Engineering Thermodynamics, Chemical Reaction Engineering, Statistical and Numerical Methods for Chemical Engineering} \\ \vspace{3pt}
        
        \textbf{Electives coursework:}{Advanced Process Systems Engineering, Electrochemical Energy Technologies,  Linear and Nonlinear Optimization, Oil and Gas Refining}
    }}
  \resumeSubHeadingListEnd
