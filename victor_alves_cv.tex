    ...
    \resumeSubheading
      ...
      {Graduate Research Assistant (Ph.D.)}{Aug 2020 \textbf{--} Currently}
        \resumeItemListStart
            ...
            \resumeItem{Modeling and simulation of Ex-situ Carbon Mineralization using Coal Fly Ash and the Recovery of Rare Earth Elements.}
        \resumeItemListEnd
    
    \resumeSubheading
      {Federal University of Campina Grande}{Campina Grande, Paraiba, Brazil}
      {undergraduate Research  (M.Sc.)}{Sep 2017 \textbf{--} Mar 2020}
        \resumeItemListStart
...
\section{Work Experience}
  ...
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      {Visiting Scholar (Ph.D.)}{Jul. 2023  \textbf{--} Currently}
        \resumeItemListStart
...
\section{Skills}
  ...
  \resumeSubHeadingListStart
    \small{\item{
        ...
        \textbf{Technologies/Platforms:}{ Git, GitHub, Simulink} \\ \vspace{3pt}
